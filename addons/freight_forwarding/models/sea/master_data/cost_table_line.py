...
class FreightSeaCostTableLine(models.Model):
    _name = 'freight.sea.cost.table.line'
    _description = 'Freight Sea Cost Table Line'

    cost_table_id = fields.Many2one(
        'freight.sea.cost.table', required=True, ondelete='cascade',
    )
